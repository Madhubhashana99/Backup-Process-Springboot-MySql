package com.Feedhub.BackupProcess;
...
public class BackupController {
    ...
    public ResponseEntity<String> createBackup() {
        String path = "C:\\Users\\Hp\\Desktop"; // import the backup path
        String dbName = "feedhub";//Here import the database name
        String dbUser = "root";
        ...
        String backupFileName = path + "\\Feed_Hub" + timestamp + ".sql";
